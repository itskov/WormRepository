...
def main():
	...
	send_mail("Eyal.Itskovits@mail.huji.ac.il",["itskov@gmail.com","Yifat.Eliezer@mail.huji.ac.il ","alonzas@gmail.com","eduard.bokman@mail.huji.ac.il"],subject,text,[currentBoxesFileName,currentStrainFileName,currentDbBUFileName],'outmail.huji.ac.il')
